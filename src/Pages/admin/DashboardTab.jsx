...
function DashboardTab() {
  ...
  const { mode, product, edithandle, deleteProduct, order, user, orderItem } =
    context;
              ...
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className=" flex justify-end">
                  <button
                    onClick={add}
                    type="button"
                    className="focus:outline-none text-white bg-customBlue shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-blue-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 mr-4"
                    style={{
