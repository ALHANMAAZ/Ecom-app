...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    if (!userData || !userData.user) {
      return toast.error("You have to login", {
        position: "top-center",
        autoClose: 1000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    const orderInfo = {
      ...
      email: userData.user.email, // Use logged in user's email
      userid: userData.user.uid, // Use logged in user's ID
      // paymentId, (assuming you'll handle this later)
    };
